...
\usepackage{listings} % F�r Programmcodeumgebung \
\renewcommand\lstlistingname{Source Code}   % Neue Bezeichnung f�r Listing
%\renewcommand\lstlistlistingname{Source Code Directory}   % Neue Bezeichnung f�r Listings
...
\cfoot[]{}
\ifoot[\\ \vspace{0.2cm} \psfig{figure=./ai_logo.png,height=1.2cm}]{\\ \psfig{figure=./ai_logo.png,height=1.2cm}} 
